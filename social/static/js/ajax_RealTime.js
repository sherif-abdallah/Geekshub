   ...
   $.ajax({
            ...
            success: function (notification_bar_len) {
                ...
                if(notification_bar_len > 99) {
                    elementInbox.style = "display: inline-block; font-size: 12px; padding: 2px; padding-left: 3px; font-wight: bold;";
                ...
                // }
                    ...
                    elementInbox.style = "display: inline-block; font-size: 12px; padding: 2px; padding-left: 6px; font-wight: bold;";
                    elementInbox.innerHTML = notification_bar_len;
