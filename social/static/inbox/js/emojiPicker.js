const EmojiPicker = function (options) {
    ...
    const functions = {
        ...
        render: (e, attr) => {
            ...
            const picker = `
                <div class="fg-emoji-container" oncontextmenu="return false;" style="left: ${position.left}px; top: ${position.top}px;">
                    <nav class="fg-emoji-nav">
                        <ul>
                            ${categoriesHTML}

                            <li class="fg-picker-special-buttons" id="fg-emoji-picker-move" style="display:${move_display};"><a class="fg-emoji-picker-move">${icons.move}</a></li>
                            ${this.options.closeButton ? `<li class="fg-picker-special-buttons"><a id="fg-emoji-picker-close-button" style="cursor: pointer;">` + icons.close + `</a></li>` : ''}
                        </ul>
                    </nav>
